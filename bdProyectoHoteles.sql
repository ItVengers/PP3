...
contraseña varchar(32),
  ...
  CONSTRAINT FK_UsuarioInt_Personal FOREIGN KEY (idUsersInt) REFERENCES tPersonal(idPersonal) 
  );
...
/*insert into tcliente (nombre,mail,contraseña) values ('pablo', 'pablo@pablito.com.ar', 'megustalajapi');
insert into tpersona (Apellido,DNI,Direccion,Telefono) values ('mosquera', 35222658, 'entre la cola', 1562452158) ;*/

call registro ('pablo', 'pablo@pablito.com.ar', 'megustalajapi','mosquera', 35222658, 'entre la cola', 1562452158);
